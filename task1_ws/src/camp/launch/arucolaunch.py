...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(
        'world', default_value='marker.world',
    )
    # map_yaml_arg = DeclareLaunchArgument(
    #     'map', default_value=os.path.join(pkg_camp, 'map', 'arucomap.yaml'), 
    # )
    ...
    executable='spawn_entity.py',
    arguments=[
        '-file', os.path.join(pkg_camp, 'models', 'aruco_visual_marker_2', 'model.sdf'),
        '-entity', 'aruco_marker',
        '-x', '3.0',
        '-y', '4.0',
        '-z', '0.0',
